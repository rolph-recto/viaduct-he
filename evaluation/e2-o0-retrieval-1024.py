...
def server(wrapper):
    ...
    for i2o in range(2):
        instr2 = wrapper.rotate_rows((0 + (-1024 * i2o)), v_query_1.get())
        wrapper.multiply_plain_inplace(instr2, pt1.get([i2o]))
        instr6 = wrapper.rotate_rows((0 + (-1024 * i2o)), v_keys_1.get())
        wrapper.multiply_plain_inplace(instr6, pt1.get([i2o]))
    ...
    # wrapper.client_output(v_query_1.get())
