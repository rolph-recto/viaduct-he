...
def client_pre(wrapper):
    ...
    v_a_id_1 = wrapper.build_vector("a_id", None, [0, 0], [EmptyDim(16, 0, 0, 0), FilledDim(0, 16, 1, 0, 0, 0, 0), FilledDim(1, 4, 1, 0, 0, 0, 0)])
    ...
    v_b_id_1 = wrapper.build_vector("b_id", None, [0, 0], [FilledDim(0, 16, 1, 0, 0, 0, 0), EmptyDim(16, 0, 0, 0), FilledDim(1, 4, 1, 0, 0, 0, 0)])
...
def server(wrapper):
    ...
    wrapper.multiply_plain_inplace(instr13, const_neg1.get())
    wrapper.add_plain_inplace(instr13, const_1.get())
    instr23 = wrapper.rotate_rows(-32, instr13)
    wrapper.multiply_inplace(instr13, instr23)
    wrapper.relinearize_inplace(instr13)
    instr25 = wrapper.rotate_rows(-16, instr13)
    wrapper.multiply_inplace(instr13, instr25)
    wrapper.relinearize_inplace(instr13)
    instr27 = wrapper.rotate_rows(-8, instr13)
    wrapper.multiply_inplace(instr13, instr27)
    wrapper.relinearize_inplace(instr13)
    instr29 = wrapper.rotate_rows(-4, instr13)
