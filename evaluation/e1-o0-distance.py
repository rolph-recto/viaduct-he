...
def server(wrapper):
    ...
    v_tests_1 = wrapper.build_vector("tests", Roll(1,0), [0, 12], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_2 = wrapper.build_vector("tests", Roll(1,0), [0, 28], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_3 = wrapper.build_vector("tests", Roll(1,0), [0, 34], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_4 = wrapper.build_vector("tests", Roll(1,0), [0, 50], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_5 = wrapper.build_vector("tests", Roll(1,0), [0, 5], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_6 = wrapper.build_vector("tests", Roll(1,0), [0, 21], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_7 = wrapper.build_vector("tests", Roll(1,0), [0, 0], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_8 = wrapper.build_vector("tests", Roll(1,0), [0, 55], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_9 = wrapper.build_vector("tests", Roll(1,0), [0, 33], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_10 = wrapper.build_vector("tests", Roll(1,0), [0, 53], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_11 = wrapper.build_vector("tests", Roll(1,0), [0, 29], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_12 = wrapper.build_vector("tests", Roll(1,0), [0, 43], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_13 = wrapper.build_vector("tests", Roll(1,0), [0, 15], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_14 = wrapper.build_vector("tests", Roll(1,0), [0, 63], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_15 = wrapper.build_vector("tests", Roll(1,0), [0, 30], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_16 = wrapper.build_vector("tests", Roll(1,0), [0, 38], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_17 = wrapper.build_vector("tests", Roll(1,0), [0, 39], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_18 = wrapper.build_vector("tests", Roll(1,0), [0, 32], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_19 = wrapper.build_vector("tests", Roll(1,0), [0, 45], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_20 = wrapper.build_vector("tests", Roll(1,0), [0, 24], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_21 = wrapper.build_vector("tests", Roll(1,0), [0, 61], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_22 = wrapper.build_vector("tests", Roll(1,0), [0, 56], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_23 = wrapper.build_vector("tests", Roll(1,0), [0, 17], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_24 = wrapper.build_vector("tests", Roll(1,0), [0, 8], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_25 = wrapper.build_vector("tests", Roll(1,0), [0, 49], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_26 = wrapper.build_vector("tests", Roll(1,0), [0, 23], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_27 = wrapper.build_vector("tests", Roll(1,0), [0, 14], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_28 = wrapper.build_vector("tests", Roll(1,0), [0, 40], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_29 = wrapper.build_vector("tests", Roll(1,0), [0, 27], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_30 = wrapper.build_vector("tests", Roll(1,0), [0, 51], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_31 = wrapper.build_vector("tests", Roll(1,0), [0, 52], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_32 = wrapper.build_vector("tests", Roll(1,0), [0, 10], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_33 = wrapper.build_vector("tests", Roll(1,0), [0, 4], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_34 = wrapper.build_vector("tests", Roll(1,0), [0, 11], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_35 = wrapper.build_vector("tests", Roll(1,0), [0, 48], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_36 = wrapper.build_vector("tests", Roll(1,0), [0, 19], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_37 = wrapper.build_vector("tests", Roll(1,0), [0, 46], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_38 = wrapper.build_vector("tests", Roll(1,0), [0, 16], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_39 = wrapper.build_vector("tests", Roll(1,0), [0, 58], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_40 = wrapper.build_vector("tests", Roll(1,0), [0, 37], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_41 = wrapper.build_vector("tests", Roll(1,0), [0, 60], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_42 = wrapper.build_vector("tests", Roll(1,0), [0, 20], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_43 = wrapper.build_vector("tests", Roll(1,0), [0, 47], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_44 = wrapper.build_vector("tests", Roll(1,0), [0, 6], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_45 = wrapper.build_vector("tests", Roll(1,0), [0, 13], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_46 = wrapper.build_vector("tests", Roll(1,0), [0, 36], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_47 = wrapper.build_vector("tests", Roll(1,0), [0, 9], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_48 = wrapper.build_vector("tests", Roll(1,0), [0, 41], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_49 = wrapper.build_vector("tests", Roll(1,0), [0, 57], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_50 = wrapper.build_vector("tests", Roll(1,0), [0, 62], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_51 = wrapper.build_vector("tests", Roll(1,0), [0, 26], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_52 = wrapper.build_vector("tests", Roll(1,0), [0, 31], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_53 = wrapper.build_vector("tests", Roll(1,0), [0, 1], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_54 = wrapper.build_vector("tests", Roll(1,0), [0, 54], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_55 = wrapper.build_vector("tests", Roll(1,0), [0, 59], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_56 = wrapper.build_vector("tests", Roll(1,0), [0, 3], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_57 = wrapper.build_vector("tests", Roll(1,0), [0, 18], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_58 = wrapper.build_vector("tests", Roll(1,0), [0, 42], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_59 = wrapper.build_vector("tests", Roll(1,0), [0, 22], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    v_tests_60 = wrapper.build_vector("tests", Roll(1,0), [0, 7], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    ...
    v_tests_63 = wrapper.build_vector("tests", Roll(1,0), [0, 25], [FilledDim(0, 64, 1, 0, 0, 0, 0)])
    ...
    wrapper.set(pt1, [0], v_tests_7.get())
    wrapper.set(pt1, [1], v_tests_53.get())
    wrapper.set(pt1, [2], v_tests_64.get())
    wrapper.set(pt1, [3], v_tests_56.get())
    wrapper.set(pt1, [4], v_tests_33.get())
    wrapper.set(pt1, [5], v_tests_5.get())
    wrapper.set(pt1, [6], v_tests_44.get())
    wrapper.set(pt1, [7], v_tests_60.get())
    wrapper.set(pt1, [8], v_tests_24.get())
    wrapper.set(pt1, [9], v_tests_47.get())
    wrapper.set(pt1, [10], v_tests_32.get())
    wrapper.set(pt1, [11], v_tests_34.get())
    wrapper.set(pt1, [12], v_tests_1.get())
    wrapper.set(pt1, [13], v_tests_45.get())
    wrapper.set(pt1, [14], v_tests_27.get())
    wrapper.set(pt1, [15], v_tests_13.get())
    wrapper.set(pt1, [16], v_tests_38.get())
    wrapper.set(pt1, [17], v_tests_23.get())
    wrapper.set(pt1, [18], v_tests_57.get())
    wrapper.set(pt1, [19], v_tests_36.get())
    wrapper.set(pt1, [20], v_tests_42.get())
    wrapper.set(pt1, [21], v_tests_6.get())
    wrapper.set(pt1, [22], v_tests_59.get())
    wrapper.set(pt1, [23], v_tests_26.get())
    wrapper.set(pt1, [24], v_tests_20.get())
    wrapper.set(pt1, [25], v_tests_63.get())
    wrapper.set(pt1, [26], v_tests_51.get())
    wrapper.set(pt1, [27], v_tests_29.get())
    wrapper.set(pt1, [28], v_tests_2.get())
    wrapper.set(pt1, [29], v_tests_11.get())
    wrapper.set(pt1, [30], v_tests_15.get())
    wrapper.set(pt1, [31], v_tests_52.get())
    wrapper.set(pt1, [32], v_tests_18.get())
    wrapper.set(pt1, [33], v_tests_9.get())
    wrapper.set(pt1, [34], v_tests_3.get())
    wrapper.set(pt1, [35], v_tests_62.get())
    wrapper.set(pt1, [36], v_tests_46.get())
    wrapper.set(pt1, [37], v_tests_40.get())
    wrapper.set(pt1, [38], v_tests_16.get())
    wrapper.set(pt1, [39], v_tests_17.get())
    wrapper.set(pt1, [40], v_tests_28.get())
    wrapper.set(pt1, [41], v_tests_48.get())
    wrapper.set(pt1, [42], v_tests_58.get())
    wrapper.set(pt1, [43], v_tests_12.get())
    wrapper.set(pt1, [44], v_tests_61.get())
    wrapper.set(pt1, [45], v_tests_19.get())
    wrapper.set(pt1, [46], v_tests_37.get())
    wrapper.set(pt1, [47], v_tests_43.get())
    wrapper.set(pt1, [48], v_tests_35.get())
    wrapper.set(pt1, [49], v_tests_25.get())
    wrapper.set(pt1, [50], v_tests_4.get())
    wrapper.set(pt1, [51], v_tests_30.get())
    wrapper.set(pt1, [52], v_tests_31.get())
    wrapper.set(pt1, [53], v_tests_10.get())
    wrapper.set(pt1, [54], v_tests_54.get())
    wrapper.set(pt1, [55], v_tests_8.get())
    wrapper.set(pt1, [56], v_tests_22.get())
    wrapper.set(pt1, [57], v_tests_49.get())
    wrapper.set(pt1, [58], v_tests_39.get())
    wrapper.set(pt1, [59], v_tests_55.get())
