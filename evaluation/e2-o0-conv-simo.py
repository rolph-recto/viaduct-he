...
def server(wrapper):
    ...
    v_filter_1 = wrapper.build_vector("filter", None, [0, 0, 0], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    v_filter_2 = wrapper.build_vector("filter", None, [0, 2, 1], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    v_filter_3 = wrapper.build_vector("filter", None, [0, 0, 1], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    v_filter_4 = wrapper.build_vector("filter", None, [0, 1, 0], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    v_filter_5 = wrapper.build_vector("filter", None, [0, 2, 0], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    v_filter_6 = wrapper.build_vector("filter", None, [0, 0, 2], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    ...
    v_filter_9 = wrapper.build_vector("filter", None, [0, 2, 2], [EmptyDim(30, 0, 0, 2), FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2)])
    ...
    wrapper.set(pt2, [0, 0], v_filter_1.get())
    wrapper.set(pt2, [0, 1], v_filter_4.get())
    wrapper.set(pt2, [0, 2], v_filter_5.get())
    wrapper.set(pt2, [1, 0], v_filter_3.get())
    wrapper.set(pt2, [1, 1], v_filter_7.get())
    wrapper.set(pt2, [1, 2], v_filter_2.get())
    wrapper.set(pt2, [2, 0], v_filter_6.get())
    wrapper.set(pt2, [2, 1], v_filter_8.get())
    wrapper.set(pt2, [2, 2], v_filter_9.get())
    __out = wrapper.ciphertext_array([], 0)
    __reduce_2 = wrapper.ciphertext_array([], 0)
    for i6 in range(3):
        __reduce_1 = wrapper.ciphertext_array([], 0)
        for i9 in range(3):
            instr1 = wrapper.rotate_rows(((0 + (-128 * i9)) + (-1 * i6)), v_img_1.get())
            wrapper.multiply_plain_inplace(instr1, mask_1.get())
            wrapper.multiply_plain_inplace(instr1, pt2.get([i9, i6]))
