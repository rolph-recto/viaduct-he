...
def client_pre(wrapper):
    ...
    v_B_1 = wrapper.build_vector("B", None, [0, 0], [EmptyDim(16, 0, 0, 0), FilledDim(0, 16, 1, 0, 0, 0, 0), FilledDim(1, 16, 1, 0, 0, 0, 0)])
...
def server(wrapper):
    ...
    v_A2_1 = wrapper.build_vector("A2", None, [0, 0], [FilledDim(1, 16, 1, 0, 0, 0, 0), FilledDim(0, 16, 1, 0, 0, 0, 0), EmptyDim(16, 0, 0, 0)])
    v_A1_1 = wrapper.build_vector("A1", None, [0, 0], [FilledDim(0, 16, 1, 0, 0, 0, 0), FilledDim(1, 16, 1, 0, 0, 0, 0), EmptyDim(16, 0, 0, 0)])
    v_B_1 = wrapper.server_recv("v_B_1")
    const_neg1 = wrapper.const(-1)
    mask_1 = wrapper.mask([(16, 0, 15), (16, 0, 0), (16, 0, 15)])
    ...
    instr3 = wrapper.rotate_rows(-128, instr2)
    wrapper.add_inplace(instr2, instr3)
    instr5 = wrapper.rotate_rows(-64, instr2)
    wrapper.add_inplace(instr2, instr5)
    instr7 = wrapper.rotate_rows(-32, instr2)
    wrapper.add_inplace(instr2, instr7)
    instr9 = wrapper.rotate_rows(-16, instr2)
    ...
    for i in range(1):
        ...
        instr14 = wrapper.rotate_rows(16, instr13)
        wrapper.add_inplace(instr13, instr14)
        instr16 = wrapper.rotate_rows(32, instr13)
        wrapper.add_inplace(instr13, instr16)
        instr18 = wrapper.rotate_rows(64, instr13)
        wrapper.add_inplace(instr13, instr18)
        instr20 = wrapper.rotate_rows(128, instr13)
    ...
    instr25 = wrapper.rotate_rows(-2048, instr24)
    wrapper.add_inplace(instr24, instr25)
    instr27 = wrapper.rotate_rows(-1024, instr24)
    wrapper.add_inplace(instr24, instr27)
    instr29 = wrapper.rotate_rows(-512, instr24)
    wrapper.add_inplace(instr24, instr29)
    instr31 = wrapper.rotate_rows(-256, instr24)
