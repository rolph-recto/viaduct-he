...
def client_pre(wrapper):
    ...
    v_b_data_1 = wrapper.build_vector("b_data", None, [0], [FilledDim(0, 32, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_b_data_1", v_b_data_1)
    v_a_id_1 = wrapper.build_vector("a_id", None, [0, 0], [FilledDim(0, 32, 1, 0, 0, 0, 0), EmptyDim(32, 0, 0, 0), FilledDim(1, 5, 1, 0, 3, 0, 0)])
    wrapper.client_send("v_a_id_1", v_a_id_1)
    v_b_id_1 = wrapper.build_vector("b_id", None, [0, 0], [EmptyDim(32, 0, 0, 0), FilledDim(0, 32, 1, 0, 0, 0, 0), FilledDim(1, 5, 1, 0, 3, 0, 0)])
    wrapper.client_send("v_b_id_1", v_b_id_1)
    v_a_data_1 = wrapper.build_vector("a_data", None, [0], [FilledDim(0, 32, 1, 0, 0, 0, 0)])
...
def server(wrapper):
    ...
    instr1 = wrapper.rotate_rows(-16, v_a_data_1.get())
    wrapper.add_inplace(instr1, v_a_data_1.get())
    instr3 = wrapper.rotate_rows(-8, instr1)
    wrapper.add_inplace(instr1, instr3)
    instr5 = wrapper.rotate_rows(-4, instr1)
    wrapper.add_inplace(instr1, instr5)
    instr7 = wrapper.rotate_rows(-2, instr1)
    wrapper.add_inplace(instr1, instr7)
    instr9 = wrapper.rotate_rows(-1, instr1)
    wrapper.add_inplace(instr1, instr9)
    wrapper.set(a_sum, [], instr1)
    b_sum = wrapper.ciphertext_array([], 0)
    instr15 = wrapper.subtract(v_a_id_1.get(), v_b_id_1.get())
    wrapper.multiply_inplace(instr15, instr15)
    wrapper.relinearize_inplace(instr15)
    wrapper.multiply_plain_inplace(instr15, const_neg1.get())
    wrapper.add_plain_inplace(instr15, const_1.get())
    instr19 = wrapper.rotate_rows(-4, instr15)
    wrapper.multiply_inplace(instr15, instr19)
    wrapper.relinearize_inplace(instr15)
    instr21 = wrapper.rotate_rows(-2, instr15)
    wrapper.multiply_inplace(instr15, instr21)
    wrapper.relinearize_inplace(instr15)
    instr23 = wrapper.rotate_rows(-1, instr15)
    wrapper.multiply_inplace(instr15, instr23)
    wrapper.relinearize_inplace(instr15)
    wrapper.multiply_plain_inplace(instr15, const_neg1.get())
    wrapper.add_plain_inplace(instr15, const_1.get())
    instr27 = wrapper.rotate_rows(-4096, instr15)
    wrapper.multiply_inplace(instr15, instr27)
    wrapper.relinearize_inplace(instr15)
    instr29 = wrapper.rotate_rows(-2048, instr15)
    wrapper.multiply_inplace(instr15, instr29)
    wrapper.relinearize_inplace(instr15)
    instr31 = wrapper.rotate_rows(-1024, instr15)
    wrapper.multiply_inplace(instr15, instr31)
    wrapper.relinearize_inplace(instr15)
    instr33 = wrapper.rotate_rows(-512, instr15)
    wrapper.multiply_inplace(instr15, instr33)
    wrapper.relinearize_inplace(instr15)
    instr35 = wrapper.rotate_rows(-256, instr15)
    wrapper.multiply_inplace(instr15, instr35)
    wrapper.relinearize_inplace(instr15)
    wrapper.multiply_inplace(instr15, v_b_data_1.get())
    wrapper.relinearize_inplace(instr15)
    instr38 = wrapper.rotate_rows(-16, instr15)
    wrapper.add_inplace(instr15, instr38)
    instr40 = wrapper.rotate_rows(-8, instr15)
    wrapper.add_inplace(instr15, instr40)
    instr42 = wrapper.rotate_rows(-4, instr15)
    wrapper.add_inplace(instr15, instr42)
    instr44 = wrapper.rotate_rows(-2, instr15)
    wrapper.add_inplace(instr15, instr44)
    instr46 = wrapper.rotate_rows(-1, instr15)
    wrapper.add_inplace(instr15, instr46)
    wrapper.set(b_sum, [], instr15)
    __out = wrapper.ciphertext_array([], 0)
    instr50 = wrapper.add(a_sum.get(), b_sum.get())
    wrapper.set(__out, [], instr50)
