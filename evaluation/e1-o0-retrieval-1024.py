...
def client_pre(wrapper):
    ...
    v_query_2 = wrapper.build_vector("query", None, [2], [EmptyDim(1024, 0, 0, 0)])
    ...
    v_query_4 = wrapper.build_vector("query", None, [9], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_4", v_query_4)
    v_keys_2 = wrapper.build_vector("keys", None, [0, 1], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_2", v_keys_2)
    v_keys_3 = wrapper.build_vector("keys", None, [0, 6], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_3", v_keys_3)
    v_query_5 = wrapper.build_vector("query", None, [0], [EmptyDim(1024, 0, 0, 0)])
    ...
    v_keys_5 = wrapper.build_vector("keys", None, [0, 9], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    ...
    v_query_7 = wrapper.build_vector("query", None, [4], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_7", v_query_7)
    v_keys_6 = wrapper.build_vector("keys", None, [0, 2], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_6", v_keys_6)
    v_keys_7 = wrapper.build_vector("keys", None, [0, 5], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_7", v_keys_7)
    v_query_8 = wrapper.build_vector("query", None, [1], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_8", v_query_8)
    v_query_9 = wrapper.build_vector("query", None, [5], [EmptyDim(1024, 0, 0, 0)])
    ...
    v_keys_9 = wrapper.build_vector("keys", None, [0, 7], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_9", v_keys_9)
    v_keys_10 = wrapper.build_vector("keys", None, [0, 3], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
...
def server(wrapper):
    ...
    wrapper.set(ct2, [2], v_keys_6.get())
    wrapper.set(ct2, [3], v_keys_10.get())
    wrapper.set(ct2, [4], v_keys_4.get())
    wrapper.set(ct2, [5], v_keys_7.get())
    wrapper.set(ct2, [6], v_keys_3.get())
    wrapper.set(ct2, [7], v_keys_9.get())
    wrapper.set(ct2, [8], v_keys_1.get())
    wrapper.set(ct2, [9], v_keys_5.get())
    ct1 = wrapper.ciphertext_array([10], 0)
    wrapper.set(ct1, [0], v_query_5.get())
    wrapper.set(ct1, [1], v_query_8.get())
    wrapper.set(ct1, [2], v_query_2.get())
    wrapper.set(ct1, [3], v_query_1.get())
    wrapper.set(ct1, [4], v_query_7.get())
    wrapper.set(ct1, [5], v_query_9.get())
    wrapper.set(ct1, [6], v_query_10.get())
    wrapper.set(ct1, [7], v_query_3.get())
    wrapper.set(ct1, [8], v_query_6.get())
    wrapper.set(ct1, [9], v_query_4.get())
    mask = wrapper.ciphertext_array([], 0)
    __reduce_1 = wrapper.ciphertext_array([], 1)
    for i5 in range(10):
        instr3 = wrapper.subtract(ct1.get([i5]), ct2.get([i5]))
