...
def client_pre(wrapper):
    ...
    v_query_1 = wrapper.build_vector("query", None, [2], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_1", v_query_1)
    v_query_2 = wrapper.build_vector("query", None, [4], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_2", v_query_2)
    v_keys_1 = wrapper.build_vector("keys", None, [0, 0], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_1", v_keys_1)
    v_keys_2 = wrapper.build_vector("keys", None, [0, 8], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_2", v_keys_2)
    v_keys_3 = wrapper.build_vector("keys", None, [0, 2], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    wrapper.client_send("v_keys_3", v_keys_3)
    v_query_3 = wrapper.build_vector("query", None, [5], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_3", v_query_3)
    v_query_4 = wrapper.build_vector("query", None, [1], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_4", v_query_4)
    v_query_5 = wrapper.build_vector("query", None, [7], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_5", v_query_5)
    v_query_6 = wrapper.build_vector("query", None, [8], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_6", v_query_6)
    v_query_7 = wrapper.build_vector("query", None, [0], [EmptyDim(1024, 0, 0, 0)])
    wrapper.client_send("v_query_7", v_query_7)
    v_query_8 = wrapper.build_vector("query", None, [9], [EmptyDim(1024, 0, 0, 0)])
    ...
    v_keys_6 = wrapper.build_vector("keys", None, [0, 5], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    ...
    v_keys_8 = wrapper.build_vector("keys", None, [0, 1], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
    ...
    v_keys_10 = wrapper.build_vector("keys", None, [0, 9], [FilledDim(0, 1024, 1, 0, 0, 0, 0)])
...
def server(wrapper):
    ...
    wrapper.set(ct1, [0], v_query_7.get())
    wrapper.set(ct1, [1], v_query_4.get())
    wrapper.set(ct1, [2], v_query_1.get())
    wrapper.set(ct1, [3], v_query_10.get())
    wrapper.set(ct1, [4], v_query_2.get())
    wrapper.set(ct1, [5], v_query_3.get())
    wrapper.set(ct1, [6], v_query_9.get())
    wrapper.set(ct1, [7], v_query_5.get())
    wrapper.set(ct1, [8], v_query_6.get())
    wrapper.set(ct1, [9], v_query_8.get())
    ct2 = wrapper.ciphertext_array([10], 0)
    wrapper.set(ct2, [0], v_keys_1.get())
    wrapper.set(ct2, [1], v_keys_8.get())
    wrapper.set(ct2, [2], v_keys_3.get())
    wrapper.set(ct2, [3], v_keys_7.get())
    wrapper.set(ct2, [4], v_keys_4.get())
    wrapper.set(ct2, [5], v_keys_6.get())
    wrapper.set(ct2, [6], v_keys_9.get())
    wrapper.set(ct2, [7], v_keys_5.get())
    wrapper.set(ct2, [8], v_keys_2.get())
    wrapper.set(ct2, [9], v_keys_10.get())
    mask = wrapper.ciphertext_array([], 0)
    __reduce_1 = wrapper.ciphertext_array([10], 1)
    for i3 in range(10):
        instr3 = wrapper.subtract(ct1.get([i3]), ct2.get([i3]))
        ...
        wrapper.set(__reduce_1, [i3], instr3)

    prod1 = wrapper.multiply(__reduce_1.get([0]), __reduce_1.get([1]))
    wrapper.relinearize_inplace(prod1)

    prod2 = wrapper.multiply(__reduce_1.get([2]), __reduce_1.get([3]))
    wrapper.relinearize_inplace(prod2)

    prod3 = wrapper.multiply(__reduce_1.get([4]), __reduce_1.get([5]))
    wrapper.relinearize_inplace(prod3)

    prod4 = wrapper.multiply(__reduce_1.get([6]), __reduce_1.get([7]))
    wrapper.relinearize_inplace(prod4)

    prod5 = wrapper.multiply(__reduce_1.get([8]), __reduce_1.get([9]))
    wrapper.relinearize_inplace(prod5)

    prod12 = wrapper.multiply(prod1, prod2)
    wrapper.relinearize_inplace(prod12)

    prod34 = wrapper.multiply(prod3, prod4)
    wrapper.relinearize_inplace(prod34)

    prod1234 = wrapper.multiply(prod12, prod34)
    wrapper.relinearize_inplace(prod1234)

    prod = wrapper.multiply(prod1234, prod5)
    wrapper.relinearize_inplace(prod)
    
    wrapper.set(mask, [], prod)
    __out = wrapper.ciphertext_array([], 0)
    instr11 = wrapper.multiply(v_values_1.get(), mask.get())
    wrapper.relinearize_inplace(instr11)
    instr12 = wrapper.rotate_rows(-512, instr11)
    wrapper.add_inplace(instr11, instr12)
    instr14 = wrapper.rotate_rows(-256, instr11)
    wrapper.add_inplace(instr11, instr14)
    instr16 = wrapper.rotate_rows(-128, instr11)
    wrapper.add_inplace(instr11, instr16)
    instr18 = wrapper.rotate_rows(-64, instr11)
    wrapper.add_inplace(instr11, instr18)
    instr20 = wrapper.rotate_rows(-32, instr11)
    wrapper.add_inplace(instr11, instr20)
    instr22 = wrapper.rotate_rows(-16, instr11)
    wrapper.add_inplace(instr11, instr22)
    instr24 = wrapper.rotate_rows(-8, instr11)
    wrapper.add_inplace(instr11, instr24)
    instr26 = wrapper.rotate_rows(-4, instr11)
    wrapper.add_inplace(instr11, instr26)
    instr28 = wrapper.rotate_rows(-2, instr11)
    wrapper.add_inplace(instr11, instr28)
    instr30 = wrapper.rotate_rows(-1, instr11)
    wrapper.add_inplace(instr11, instr30)
