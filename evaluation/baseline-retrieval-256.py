...
def server(wrapper):
    ...
    v_query = wrapper.server_recv("v_query")
    v_values = []
    v_keys = []
    for i in range(256):
        v_values.append(wrapper.server_recv("v_values_{}".format(i)))
        v_keys.append(wrapper.server_recv("v_keys_{}".format(i)))
