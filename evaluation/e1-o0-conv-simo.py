...
def server(wrapper):
    ...
    v_filter_3 = wrapper.build_vector("filter", None, [0, 2, 1], [FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2), EmptyDim(30, 0, 0, 2)])
    v_filter_4 = wrapper.build_vector("filter", None, [0, 1, 0], [FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2), EmptyDim(30, 0, 0, 2)])
    v_filter_5 = wrapper.build_vector("filter", None, [0, 2, 0], [FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2), EmptyDim(30, 0, 0, 2)])
    v_filter_6 = wrapper.build_vector("filter", None, [0, 0, 1], [FilledDim(0, 4, 1, 0, 0, 0, 0), EmptyDim(30, 0, 0, 2), EmptyDim(30, 0, 0, 2)])
    ...
    wrapper.set(pt2, [1, 2], v_filter_3.get())
    ...
    for i0 in range(3):
        ...
        for i6 in range(3):
            instr1 = wrapper.rotate_rows(((0 + (-1 * i6)) + (-32 * i0)), v_img_1.get())
            wrapper.multiply_plain_inplace(instr1, mask_1.get())
            wrapper.multiply_plain_inplace(instr1, pt2.get([i6, i0]))
